# chronforge-verification-harness Specification

## Purpose

Define ChronForge's project-local verification skill and executable verification-tool contract by composing upstream pstack verification discipline, qstack deterministic-quant verification semantics, and ChronForge-owned executable levers/evidence.
