# chronforge-development-flow Specification

## Purpose

Define ChronForge's durable intent-driven software-development lifecycle and the ownership boundaries among OpenSpec, qstack, upstream pstack, ChronForge project state, and qorch research orchestration.
